        ...
        when (packet.questionMode) {
            ...
            ReviewChatQuestionMode.COLLECTION_OVERVIEW -> {
                ...
                if (packet.wantsCategories) {
                    ...
                    appendLine("6. 不要输出 `【依据】` 或 `【下一步】`，也不要输出 Markdown 表格。")
                } else {
            ...
            ReviewChatQuestionMode.RECORD_LOOKUP -> {
                ...
                if (packet.wantsCategories) {
                    ...
                    appendLine("4. 不要输出 `【依据】` 或 `【下一步】`。如果用户没有明确要求逐条列记录，就不要追加 `【记录】`。不要输出 Markdown 表格。")
                } else {
            ...
            systemInstruction = buildString {
                ...
                when (packet.questionMode) {
                    ...
                    ReviewChatQuestionMode.COLLECTION_OVERVIEW -> {
                        ...
                        if (packet.wantsCategories) {
                            appendLine("输出协议：先写 `【答复】`，再写 `【类别】`，每条都用 `- 类别：说明`。不要输出 `【依据】` 或 `【下一步】`，也不要输出表格。")
                        } else {
                    ...
                    ReviewChatQuestionMode.RECORD_LOOKUP -> {
                        ...
                        if (packet.wantsCategories) {
                            appendLine("输出协议：先写 `【答复】`，再写 `【类别】`，每条都用 `- 类别：包含的信息`。如果用户没有明确要求逐条列记录，就不要写 `【记录】`。不要输出表格。")
                        } else {
